...
class FilmList extends Model {
	...
	protected $fillable = ['id', 'film_name_en', 'film_name_vn', 'film_category', 'film_time', 'film_years', 'film_quality', 'film_language', 'film_thumbnail_small', 'film_vote', 'film_vote_count', 'film_viewed', 'film_dir_name', 'film_status'];
