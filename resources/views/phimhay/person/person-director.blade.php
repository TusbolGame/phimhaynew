...
@section('title', $person->person_name.' | Phim Đã Đạo Diễn | PhimHay')
@section('description', 'Phim đã đạo diễn của '.$person->person_name)
@section('css')
	<!-- slick -->
...
@section('film-dir')
	<div class="film-dir">
		<ol class="breadcrumb">
		  	...
		  	<li class="active"><a href="{!! route('person.getPersonDirector', $person->id) !!}" title="Phim đạo diễn">Phim Đạo Diễn</a></li>
		</ol>
	</div>
@stop
@section('content')
	<div class="film-new">
		<div class="list-film-new">
			<div class="film-new-title">
				<p><span class="glyphicon glyphicon-pencil"></span> PHIM ĐÃ ĐẠO DIỄN - {!! $person->person_name !!} ({!! $film_director->total() !!})</p>
			</div>
